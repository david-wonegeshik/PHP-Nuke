...
define("_DOWNLOADSNOTUSER2","Se você fosse um usuário registrado poderia enviar arquivos para downloads neste site.");
define("_DOWNLOADSNOTUSER3","Para se tornar um usuário registrado o processo é rápido e fácil.");
define("_DOWNLOADSNOTUSER4","Por que nós requeremos o seu registro para acessar certas áreas?");
define("_DOWNLOADSNOTUSER5","Porque só assim poderemos lhe oferecer um conteúdo da mais alta qualidade,");
...
define("_DOWNLOADSNOTUSER8","<a href=\"modules.php?name=Your_Account\">Registre uma Conta</a>");
define("_DOWNLOADALREADYEXT","ERRO: Esta URL já existe no Banco de Dados!");
define("_DOWNLOADNOTITLE","ERRO: Você precisa digitar um título para sua URL!");
define("_DOWNLOADNOURL","ERRO: Você precisa digitar uma URL para sua URL!");
define("_DOWNLOADNODESC","ERRO: Você precisa digitar uma descrição para sua URL!");
define("_DOWNLOADRECEIVED","Nós recebemos o envio do seu arquivo. Obrigado!");
...
define("_DLETSDECIDE","Recomendação de usuários como você ajudará melhor a outros visitantes a fazer um download de determinado arquivo então click aqui.");
define("_DRATENOTE4","Você pode ver uma lista do<a href=\"modules.php?name=Downloads&amp;d_op=TopRated\">Dos Arquivos Mais Avaliados</a>.");
define("_DATE","Data");
define("_TO","Para");
define("_NEW","Novo");
...
define("_USERANDIP","São registrado o nome do usuário bem como o ip de quem enviou o Link, então por favor não abuse nós podemos encontra-lo.");
define("_LDESCRIPTION","Descrição: (255 máx. caracteres)");
define("_CHECKFORIT","Você não escreveu seu Email. De qualquer maneira nossa equipe irá conferir o seu Link");
...
define("_ALLOWTORATE","Permita que os outros usuários classifiquem isto apartir do seu site !");
...
define("_WEIGHNOTE","* Nota: Este recurso conta para usuários registrados. Avaliação de usuário anônimos");
define("_NOUNREGUSERSVOTES","Nenhum usuário anônimo vota");
define("_WEIGHOUTNOTE","* Nota: Este recurso pesa para usuários registrados. Fora a avaliação dos eleitores");
...
define("_HTMLCODE3","Usando desta forma permite que os usuários avaliem o conteúdo da sua página direto do seu site e esta avaliação será armazenada aqui. A forma acima é inválida, mas o código fonte seguinte funciona basta que você copie e cole na sua home-page. O código fonte é mostrado abaixo:");
...
define("_THANKSTOTAKETIME","Obrigado por usar seu tempo para avaliar um site aqui a");
