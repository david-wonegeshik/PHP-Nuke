...
<b>Forum FAQ</b></td>
    ...
    <tr bgcolor="<?php echo $color1?>">
        <td>
        <font color="<?php echo $FontColor?>" size="<?php echo $FontSize2?>" face="<?php echo $FontFace?>">
        <a name="register"><b><br>Registering</b></font></a>
        </td>
    </tr>
    <tr bgcolor="<?php echo $color2?>">
        <td>
        <font size="<?php echo $FontSize2?>" face="<?php echo $FontFace?>" color="<?php echo $FontColor?>">
        ...
        <a href="modules.php?name=Your_Account">here</a></font>
        </td>
    </tr>
    <tr bgcolor="<?php echo $color1?>">
        <td>
...
?>
                ...
                <td width="55">
                        <IMG SRC="<?php echo "images/forum/smilies/$smile[smile_url]";?>">
                </td></tr>
<?php
             }
          } else
...
<P>
    ...
    <tr bgcolor="<?php echo $color2?>">
        ...
        <?php
        $sql = "SELECT * FROM ".$prefix."_ranks WHERE rank_special = 0";
        ...
        <TD><font face="<?php echo $FontFace?>" size="<?php echo $FontSize2?>" color="<?php echo $FontColor?>">&nbsp;Rank Title&nbsp;</font></TD>
        <TD><font face="<?php echo $FontFace?>" size="<?php echo $FontSize2?>" color="<?php echo $FontColor?>">&nbsp;Minimum Posts&nbsp;</font></TD>
        <TD><font face="<?php echo $FontFace?>" size="<?php echo $FontSize2?>" color="<?php echo $FontColor?>">&nbsp;Maximum Posts&nbsp;</font></TD>
        <TD><font face="<?php echo $FontFace?>" size="<?php echo $FontSize2?>" color="<?php echo $FontColor?>">&nbsp;Rank Image&nbsp;</font></TD>
        </TR>
        <?php
        if($m = mysql_fetch_array($r)) {
        do {
        echo "<TR BGCOLOR=\"$color2\" ALIGN=\"CENTER\">";
        echo "<TD><font face=\"<?php echo $FontFace?>\" size=\"2\" color=\"$FontColor\">$m[rank_title]</font></TD>";
        echo "<TD><font face=\"<?php echo $FontFace?>\" size=\"2\" color=\"$FontColor\">$m[rank_min]</font></TD>";
        echo "<TD><font face=\"<?php echo $FontFace?>\" size=\"2\" color=\"$FontColor\">$m[rank_max]</font></TD>";
        if($m[rank_image] != '')
           echo "<TD><img src=\"images/forum/special/$m[rank_image]\"></TD>";
        else
           echo "<TD>&nbsp;</TD>";
        echo "</TR>";
