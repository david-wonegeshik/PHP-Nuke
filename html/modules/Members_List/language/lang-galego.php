...
define("_FUNCTIONS","Funciуns");
define("_PREVIOUS","Pбxina anterior");
define("_MEMBERSLIST","Lista de Membros");
define("_GREETINGS","Felicidades у noso ъltimo usuario rexistrado:");
define("_SORTBY","Ordeado por:");
define("_MNICKNAME","Alias");
define("_MREALNAME","Nome real");
define("_MEMAIL","E-Mail");
define("_MURL","URL");
define("_ONLINEREG","Usuarios rexistrados en lнсa agora:");
define("_WEHAVE","Temos");
define("_MREGISTERED","usuarios rexistrados ata agora. Hai");
define("_MREGONLINE","usuario(s) rexistrado(s) en lнсa agora mesmo.");
...
define("_PAGES","Pбxinas");
define("_HOMEPAGE","Pбxina de Inicio");
